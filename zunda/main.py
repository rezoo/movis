...
from zunda.utils import get_voicevox_dataframe, get_audio_length, get_paths
...
def make_ass_file(audio_dir: str, timeline_path: str, dst_ass_path: str, font_name: str) -> None:
    timeline = pd.read_csv(timeline_path)
    timeline = pd.merge(timeline, get_voicevox_dataframe(audio_dir), left_index=True, right_index=True)
...
Style: Default,{font_name},96,&Hffffff,&Hffffff,&H0,&H0,0,0,0,0,100,100,0,0,1,5,0,2,10,10,25,1
...
def make_video(args: argparse.Namespace):
    ...
    make_ass_file(config['audio']['audio_dir'], config['timeline_path'], config['video']['subtitle_path'], config['font'])
    render_video(
